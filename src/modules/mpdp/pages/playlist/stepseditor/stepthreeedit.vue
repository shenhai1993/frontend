        ...
        <el-col :span='20'>
          <el-form-item label="播出单" :label-width="formLabelWidth"
            ...
            <el-input v-model="formData.name" auto-complete="off"
                      placeholder="请输入播出单名称" maxlength="12" show-word-limit></el-input>
          </el-form-item>
          ...
          <el-form-item label="备注" :label-width="formLabelWidth">
            <el-input type="textarea" v-model="formData.description" maxlength="20" show-word-limit></el-input>
          </el-form-item>
...
export default {
    ...
    activeSteps (v, ov) {
      if (v === 2) {
        if (this.$route.params.id) {
          ...
          this.formData.description = this.editItem.description
          return
        }
  ...
  methods: {
    ...mapMutations({
      putPublishFormData: 'PUT_PUBLISH_FORMDATA_MPDP'
    })
  }
}
</script>
